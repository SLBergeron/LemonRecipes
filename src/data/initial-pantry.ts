...
export const initialPantryData: SimplePantryItem[] = [
  ...
  // Spices & Seasonings
  { id: 'spice-ras-el-hanout', name: 'Ras El Hanout', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-tex-mex', name: 'Frontera Tex-Mex Seasoning', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-garlic-salt', name: 'Deluxe Garlic Salt', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-roasting-blend', name: 'Rustic Roasting Blend', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-tarragon-shallot', name: 'Tarragon-Shallot Blend', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-marrakesh-salmon', name: 'Marrakesh Salmon Seasoning', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-salt', name: 'Salt', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-pepper', name: 'Black Pepper', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-flour', name: 'All-Purpose Flour', current_amount: 1, unit: 'bags', category: 'pantry', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-garlic-grit', name: 'Garlic Grit', current_amount: 1, unit: 'containers', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  ...
  { id: 'spice-mustard-seeds', name: 'Yellow Mustard Seeds', current_amount: 40, unit: 'g', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  { id: 'spice-allspice', name: 'Whole Allspice', current_amount: 40, unit: 'g', category: 'spices', added_by: 'simon', updated_at: new Date().toISOString() },
  ...
  { id: 'spice-sugar', name: 'Whole Sugar', current_amount: 1, unit: 'containers', category: 'pantry', added_by: 'simon', updated_at: new Date().toISOString() },

  // Pantry Staples & Condiments
  { id: 'pantry-maple-syrup', name: 'Maple Syrup', current_amount: 150, unit: 'ml', category: 'pantry', added_by: 'simon', updated_at: new Date().toISOString() },
